...
mixin _$HomeController on _HomeControllerBase, Store {
  Computed<int> _$checkedComputed;

  @override
  int get checked => (_$checkedComputed ??= Computed<int>(() => super.checked,
          name: '_HomeControllerBase.checked'))
      .value;
  ...
  @override
  dynamic changeCheck(int index, ItemModel item) {
    final _$actionInfo = _$_HomeControllerBaseActionController.startAction(
        name: '_HomeControllerBase.changeCheck');
    try {
      return super.changeCheck(index, item);
    } finally {
      _$_HomeControllerBaseActionController.endAction(_$actionInfo);
    }
  }
